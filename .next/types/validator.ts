...
// Validate ../../src/app/api/admin/user-logs/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/user-logs">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/user-logs/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/settings/agents/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/settings/agents">> = Specific
  const handler = {} as typeof import("../../src/app/api/settings/agents/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/settings/banner/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/settings/banner">> = Specific
  const handler = {} as typeof import("../../src/app/api/settings/banner/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/telegram-alert/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/telegram-alert">> = Specific
  const handler = {} as typeof import("../../src/app/api/telegram-alert/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
